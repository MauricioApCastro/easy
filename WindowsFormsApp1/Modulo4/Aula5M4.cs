...
{
    public partial class Aula5M4 : Form
    {
        //variáveis
        string frase = "teste";
        string legenda;
...
"audio//3 black ties.wav",
"audio//9 red scarfs.wav",
...
"audio//4 earrings for 10 dollar.wav",
"audio//2 t-shirts for $ 5.wav",
"audio//$ 15 jeans.wav",
...
"four earrings for 10 dollar",
"two t-shirts for $5",
"fifteen dollars jeans",
...
"quatro brincos por 10 dólares",
"duas camisetas por 5 dólares",
"Jeans 15 doláres",
        };
...

        {
...

            {
                ...
                case 4:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.necklace1;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 6:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.necktie;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 8:
                    ...
                    pictureBox2.Image = Properties.Resources.earrings;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 9:
                    ...
                    pictureBox1.ClientSize = new Size(255, 382);//metade da tela
                    pictureBox1.Image = Properties.Resources.buy;
                    pictureBox2.Image = Properties.Resources.bracelet;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 10:
                    ...
                    pictureBox2.Image = Properties.Resources.necktie;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 11:
                    ...
                    pictureBox2.Image = Properties.Resources.scarf;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 17:
                    ...
                    pictureBox1.ClientSize = new Size(255, 382);//metade da tela
                    pictureBox1.Image = Properties.Resources.earrings;
                    pictureBox2.Image = Properties.Resources._10_dolar;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 18:
                    ...
                    pictureBox2.Image = Properties.Resources._5_dolar;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
