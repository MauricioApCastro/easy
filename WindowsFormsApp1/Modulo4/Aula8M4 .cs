...
{
    public partial class Aula8M4 : Form
    {
        //variáveis
        string frase = "teste";
        string legenda;
        ...
        {
            "audio//I wear red bikini.wav",
"audio//You wear black trunks.wav",
"audio//I buy beach umbrella.wav",
"audio//I buy sunscreen.wav",
"audio//Today is a beach day.wav",
"audio//Tomorrow let's go to farm.wav",
"audio//Saturday let's go to the pool.wav",
"audio//Sunday let's go to the beach house.wav",
"audio//She likes a pool.wav",
"audio//He likes a beach.wav",
"audio//I hate farm.wav",
"audio//I hate black bikini.wav",
"audio//Let's go to country house.wav",
        ...
        {
            "I wear red bikini",
"You wear black trunks",
"I buy beach umbrella",
"I buy sunscreen",
"Today is a beach day",
"Tomorrow let's go to farm",
"Saturday let's go to the pool",
"Sunday let's go to the beach house",
"She likes a pool",
"He likes a beach",
"I hate farm",
"I hate black bikini",
"Let's go to country house",
        ...
        public String[] listaPortugues =
        {
            ...
            "Eu visto biquíni vermelho",
"Você veste calção preto",
"Eu compro guarda-sol",
"Eu compro protetor solar",
"Hoje é dia de praia",
"Amanhã vamos para a fazenda",
"Sábado vamos para a piscina",
"Domingo vamos para a casa de praia",
"Ela gosta de piscina",
"Ele gosta de praia",
"Eu odeio fazenda",
"Eu odeio biquíni preto",
"Vamos para casa de campo",
...

        {
...

            {
                case 0:
                    ...
                    pictureBox1.Image = Properties.Resources.biquini_vermelho;
                ...
                case 1:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.calção_preto;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 2:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.beach_umbrella;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 3:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.sunscreean;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 5:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.farm;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 7:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.beach_house;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 9:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.beach1;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 11:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.bikini;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
