...
{
    public partial class Aula6M4 : Form
    {
        //variáveis
        string frase = "teste";
        string legenda;
...
"audio//to iron.wav",
"audio//clothes.wav",
"audio//washing machine.wav",
"audio//laundry.wav",
"audio//soap powder.wav",
"audio//softener.wav",
"audio//went.wav",
"audio//I wash the shirt.wav",
"audio//You wash the clothes.wav",
"audio//Today you wash clothes.wav",
"audio//Tomorrow I wash the clothes.wav",
"audio//I iron the shirts.wav",
"audio//She iron the shirts.wav",
"audio//He irons clothes.wav",
"audio//I wash clothes with washing powder and fabric softener.wav",
"audio//You wash the clothes.wav",
"audio//I buy soap and softner.wav",
"audio//He irons the pants.wav",
"audio//I wash jeans.wav",
"audio//I went to the laundry.wav",
"audio//You went to the laundry.wav",
"audio//She went to the laundry.wav",
"audio//He went to the laundry.wav",
"audio//I iron the yellow shirt.wav",
"audio//you iron the white shirt.wav",
"audio//she washes jeans.wav",
...
"Today you wash clothes",
"Tomorrow I wash the clothes",
"I iron the shirts",
"She iron the shirts",
"He irons clothes",
"I wash clothes with washing powder and fabric softener",
"You wash the clothes",
"I buy soap and softner",
"He irons the pants",
"I wash jeans",
...
"I iron the yellow shirt",
"you iron the white shirt",
"she washes jeans",
...
"Eu lavo a camisa",
"Voce lava as roupas",
"Hoje voce lava roupas",
"Amanha eu lavo a roupa",
"Eu passo as camisas",
"Ela passa as camisas",
"Ele passa roupas",
"Lavo roupas com sabão em pó e amaciante",
"Voce lava as roupas",
"Eu compro sabonete e amaciante",
"Ele passa a ferro as calças",
"Eu lavo o jeans",
"Eu fui a lavanderia",
"Você foi na lavanderia",
"Ela foi na lavanderia",
"Ele foi na lavanderia",
"eu passo a camisa amarela",
"voce passa a camisa branca",
"ela lava o jeans",
...

        {
...

            {
                case 0:
                    ...
                    pictureBox1.Image = Properties.Resources.wash;
                ...
                case 1:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.to_iron;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 2:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.clothes;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 3:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.washing_machine;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 4:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.laundry;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 5:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.soap_powder;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 6:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.softener;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 7:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.went;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 8:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.I_wash_the_shirt;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 9:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.You_wash_the_clothes;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 10:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.Today_you_wash_clothes;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 11:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.Tomorrow_I_wash_the_clothes;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 12:
                    ...
                    btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.I_iron_the_shirts;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 14:
                   ...
                   btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.He_irons_clothes;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
