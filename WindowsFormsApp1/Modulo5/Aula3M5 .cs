...
{
    public partial class Aula3M5 : Form
    {
        //variáveis
        string frase = "teste";
        string legenda;
...
"audio//City.wav",
"audio//to reside.wav",
"audio//I live in Sao Paulo.wav",
"audio//You live in the USA.wav",
"audio//She lives in the city of New Orleans.wav",
"audio//he lives on Maria Ribeiro street.wav",
"audio//I drive on the road.wav",
"audio//She drives a blue car.wav",
"audio//He drives the motorcycle on the avenue.wav",
"audio//He likes the parks.wav",
"audio//My address is Arthur Ramos Square.wav",
"audio//What is your address.wav",
"audio//She drives on Vegas street.wav",
"audio//He lives on the old road.wav",
"audio//You live in the city of São Paulo..wav",
"audio//I love park in summer.wav",
"audio//I love the city in december.wav",
"audio//You drive the yellow motorcycle.wav",
"audio//Saturday, day to go to the park.wav",
"audio//Write your address in English..wav",
...
"I live in São Paulo",
"You live in the USA",
"She lives in the city of New Orleans",
"He lives on Maria Ribeiro street",
"I drive on the road",
"She drives a blue car",
"He drives the motorcycle on the avenue",
"He likes the parks",
"My address is Arthur Ramos Square",
"What is your address",
"She drives on Vegas street",
"He lives on the old road",
"You live in the city of São Paulo",
"I love park in summer",
"I love the city in december",
"You drive the yellow motorcycle",
"Saturday, day to go to the park",
...
"Você vive no Estados Unidos",
"Ela vive na cidade de New Orleans",
"Ele vive na rua Maria Ribeiro",
"Eu dirijo na estrada",
"Ela dirige um carro azul",
"Ele pilota a moto na avenida",
"Ele gosta de parques",
"Meu endereço é Avenida Arthur Ramos",
"Qual é o seu endereço",
"Ela dirige na rua Vegas",
"Ele mora na estrada velha",
"Você vive na cidade de São Paulo",
"Eu amo parque no verão",
"Eu amo a cidade em dezembro",
"Você pilota uma moto amarela",
"Sábado, dia de ir ao parque",
"Escreva seu endereço em inglês",
...

        {
...

            {
                ...
                case 2:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.Road;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 3:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.Avenue;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 4:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.to_drive;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 6:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.Park;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 8:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.ele_mora;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 11:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.ela_mora;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
                ...
                case 15:
                    ...
                    //btProximo.Enabled = false;
                    pictureBox1.ClientSize = new Size(510, 382);//tela inteira
                    pictureBox1.Image = Properties.Resources.He_drives_the_motorcycle_on_the_avenue;
                    sd = listaAudio[num];//audio
                    txtPt.Text = listaPortugues[num];//legenda 
                    txtEn.Text = listaIngles[num];//legenda inglês
                    timerFalar.Stop();
