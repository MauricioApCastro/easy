...
{
    public partial class Aula5M5 : Form
    {
        //variáveis
        string frase = "teste";
        string legenda;
...
"audio//I eat cake with my cousins.wav",
"audio//Tomorrow Family party.wav",
"audio//Family trip.wav",
